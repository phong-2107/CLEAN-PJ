...
import { ShoppingBag, Mail, Lock, Eye, EyeOff, User, Check, ArrowRight } from 'lucide-react';
...
export const RegisterPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // (New users typically won't have Admin role)
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-purple-200/30 rounded-full blur-[100px]"></div>
            </div>
                ...
                <div className="hidden lg:block space-y-8 pr-8 animate-fade-in-left">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-lg text-gray-600 max-w-md leading-relaxed">
                            Start your shopping journey with us and enjoy premium benefits.
                        </p>
                    </div>
                    ...
                    {/* Testimonial */}
                    <div className="mt-8 p-6 bg-white/60 backdrop-blur-sm rounded-2xl border border-white shadow-sm">
                        <p className="text-gray-700 italic mb-4">
                            "Best shopping experience I've ever had! Fast delivery and amazing products."
                        </p>
                        <div className="flex items-center gap-3">
                            <div className="h-10 w-10 rounded-full bg-indigo-100 flex items-center justify-center text-primary-700 font-bold">
                                SJ
                            </div>
                            <div>
                                <p className="text-gray-900 font-bold">Sarah Johnson</p>
                                <p className="text-primary-600 text-sm font-medium">Verified Customer</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="mt-8 text-center">
                            <p className="text-gray-500">
                                ...
                                <Link to="/login" className="font-semibold text-primary-600 hover:text-primary-700 transition-colors inline-flex items-center gap-1 group">
                                    Sign In
